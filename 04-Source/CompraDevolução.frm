...
Begin VB.Form frmCompraDevoluçãoTroca 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Compra - Devolução/Troca"
   ClientHeight    =   6555
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9540
   Icon            =   "CompraDevolução.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ScaleHeight     =   6555
   ...
   Begin VB.Frame frItens 
      ...
      Begin MSDBGrid.DBGrid dbgrdItens 
         Height          =   2925
         Left            =   60
         OleObjectBlob   =   "CompraDevolução.frx":030A
         TabIndex        =   9
         Top             =   210
         Width           =   9405
      End
   ...
   End
End
Attribute VB_Name = "frmCompraDevoluçãoTroca"
